...
function renderPhotoViewer(photos) {
    ...
    return [
        ...
        `<img class="map-photo-viewer__image" data-photo-main src="${escapeHtml(firstPhoto.previewUrl || firstPhoto.fullUrl)}" alt="${escapeHtml(firstPhoto.name)}">`,
        '</div>',
...
function renderPhotoThumb(photo, index) {
    return [
        ...
        `data-photo-full="${escapeHtml(photo.fullUrl || photo.previewUrl)}" `,
